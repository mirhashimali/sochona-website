    ...
    <main className="flex flex-col items-center w-full bg-transparent text-white selection:bg-[#007AFF] selection:text-white relative overflow-hidden pb-32">
      ...
      <ScrollReveal>
        <section className="max-w-4xl mx-auto px-6 pt-28 pb-8 flex flex-col items-center text-center relative z-10">
          ...
          {/* ⚡ LIVING ARTIFACT: PIPELINE HUD */}
          <div className="w-full max-w-xl p-4 rounded-2xl bg-black/55 border border-white/20 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.6)] text-left relative overflow-hidden group hover:border-white/35 transition-all">
            <div className="flex items-center justify-between border-b border-white/10 pb-2.5 mb-3 text-[10px] font-mono text-white/60">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping"></span>
                <span className="text-white/90 font-bold uppercase tracking-wider">SOCHONA ENGINE // PIPELINE HUD</span>
              </div>
              <span className="text-blue-400 bg-blue-500/10 border border-blue-500/20 px-2 py-0.5 rounded-full">
                MUMBAI_EDGE_NODE (0.38s)
              </span>
            </div>

            <div className="space-y-2 text-[11px] font-mono">
              <div className="flex items-center justify-between text-white/80">
                <span className="text-white/50">[00:01.2s] Ingest:</span>
                <span className="truncate max-w-[280px] sm:max-w-none text-white/90">
                  Google Search <span className="text-blue-400">("B2B Precision Components Exporter")</span>
                </span>
                <span className="text-emerald-400 font-bold">VERIFIED</span>
              </div>
              <div className="flex items-center justify-between text-white/80">
                <span className="text-white/50">[00:01.8s] WhatsApp:</span>
                <span className="truncate max-w-[280px] sm:max-w-none text-white/90">
                  Autonomous Bot Dispatched (Hindi/Eng)
                </span>
                <span className="text-teal-400 font-bold">1.2s</span>
              </div>
              <div className="flex items-center justify-between text-white/80">
                <span className="text-white/50">[00:02.4s] Portal:</span>
                <span className="truncate max-w-[280px] sm:max-w-none text-white/90">
                  Meeting Booked • Synced to Portal (Zero SaaS Rent)
                </span>
                <span className="text-purple-400 font-bold">ROUTED</span>
              </div>
            </div>

            <div className="mt-3 pt-2.5 border-t border-white/10 flex items-center justify-between text-[9px] font-mono text-white/50 uppercase tracking-widest">
              <span>Latency: 38ms</span>
              <span>•</span>
              <span>LCP: 0.6s (Core Web Vitals Pass)</span>
              <span>•</span>
              <span className="text-emerald-400">100% Intent Captured</span>
            </div>
          </div>
        ...
        <ScrollReveal>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-6 rounded-3xl bg-black/50 border border-white/15 backdrop-blur-xl shadow-2xl">
            <div className="text-center p-2 border-r border-white/10 last:border-none">
              <span className="text-2xl md:text-3xl font-light text-blue-400 tracking-tight">9x</span>
              <p className="text-[10px] text-white/60 mt-1 uppercase tracking-widest font-medium">
                Conversion Odds &lt; 5min (MIT/HBR)
              </p>
            </div>
            <div className="text-center p-2 border-r border-white/10 last:border-none">
              <span className="text-2xl md:text-3xl font-light text-teal-300 tracking-tight">&lt; 0.8s</span>
              <p className="text-[10px] text-white/60 mt-1 uppercase tracking-widest font-medium">
                Edge Mobile Latency (Google Study)
              </p>
            </div>
            <div className="text-center p-2 border-r border-white/10 last:border-none">
              <span className="text-2xl md:text-3xl font-light text-emerald-400 tracking-tight">98%</span>
              <p className="text-[10px] text-white/60 mt-1 uppercase tracking-widest font-medium">
                WhatsApp Delivery Open Rate
              </p>
            </div>
            <div className="text-center p-2">
              <span className="text-2xl md:text-3xl font-light text-amber-300 tracking-tight">100%</span>
              <p className="text-[10px] text-white/60 mt-1 uppercase tracking-widest font-medium">
      ...
      {/* 3. GROUND REALITY */}
      <section className="w-full max-w-5xl mx-auto px-6 py-16 relative z-10 pointer-events-auto">
        <ScrollReveal>
          <div className="text-center mb-12">
            <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#007AFF]">The Indian Business Reality</span>
            <h2 className="text-2xl md:text-4xl font-light text-white mt-2">Aapka Digital Paisa Kahan Barbaad Ho Raha Hai?</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-black/50 border border-red-500/20 backdrop-blur-xl">
              <span className="text-[10px] font-mono text-red-400/80 uppercase tracking-widest">Purana Tariqa</span>
              <h3 className="text-lg font-medium text-white mt-1 mb-6">Freelancers & Typical Agency Retainers</h3>
              <ul className="space-y-4 text-xs text-white/70 leading-relaxed font-light">
            ...
            <div className="p-8 rounded-3xl bg-black/50 border border-blue-500/25 backdrop-blur-xl relative">
              <div className="absolute top-4 right-4 text-[10px] font-mono text-[#007AFF] uppercase tracking-widest">
                Production Standard
              </div>
              <span className="text-[10px] font-mono text-blue-400/80 uppercase tracking-widest">The Sochona System</span>
              <h3 className="text-lg font-medium text-white mt-1 mb-6">Unified Revenue Infrastructure</h3>
              <ul className="space-y-4 text-xs text-white/85 leading-relaxed font-light">
                <li className="flex items-start gap-3">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 pointer-events-auto w-full relative z-10">
        <ScrollReveal>
          <div className="text-center mb-12">
            <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#007AFF]">The Four Pillars</span>
            <h2 className="text-2xl md:text-4xl font-light text-white mt-2 mb-3">Hum Aapke Business Ke Liye Kya Karte Hain?</h2>
        ...
        <div className="flex md:grid md:grid-cols-4 gap-6 overflow-x-auto md:overflow-visible pt-8 pb-10 px-2 -mx-2 snap-x snap-mandatory scrollbar-none">
          
          <Link href="/in/zero-ad-waste" className="block min-w-[280px] sm:min-w-[320px] md:min-w-0 snap-center">
            <div className="h-full bg-black/50 border border-white/15 rounded-3xl p-7 flex flex-col justify-between backdrop-blur-xl transition-all duration-300 hover:-translate-y-2.5 hover:border-blue-500/50 hover:bg-black/70 hover:shadow-[0_15px_35px_rgba(0,122,255,0.15)] group cursor-pointer">
              <div>
                ...
                <h3 className="text-lg font-medium text-white mt-1 mb-2 group-hover:text-blue-300 transition-colors">1. High-Intent Ads</h3>
          ...
          <Link href="/in/speed-infrastructure" className="block min-w-[280px] sm:min-w-[320px] md:min-w-0 snap-center">
            <div className="h-full bg-black/50 border border-white/15 rounded-3xl p-7 flex flex-col justify-between backdrop-blur-xl transition-all duration-300 hover:-translate-y-2.5 hover:border-teal-400/50 hover:bg-black/70 hover:shadow-[0_15px_35px_rgba(20,184,166,0.15)] group cursor-pointer">
              <div>
                <div className="w-11 h-11 rounded-2xl bg-teal-500/10 border border-teal-500/25 flex items-center justify-center mb-6 text-teal-400 group-hover:scale-110 group-hover:bg-teal-500/20 transition-all">
                  <Zap className="w-5 h-5" />
                </div>
                <span className="text-[10px] font-mono uppercase tracking-widest text-teal-400/80">Phase 02</span>
                <h3 className="text-lg font-medium text-white mt-1 mb-2 group-hover:text-teal-300 transition-colors">2. Blazing Speed Web</h3>
                <p className="text-xs text-white/65 font-light leading-relaxed">
              ...
              <div className="mt-8 pt-4 border-t border-white/10 flex items-center justify-between text-xs text-teal-400 font-medium group-hover:translate-x-0.5 transition-all">
          ...
          <Link href="/in/whatsapp-automation" className="block min-w-[280px] sm:min-w-[320px] md:min-w-0 snap-center">
            <div className="h-full bg-black/50 border border-white/15 rounded-3xl p-7 flex flex-col justify-between backdrop-blur-xl transition-all duration-300 hover:-translate-y-2.5 hover:border-emerald-400/50 hover:bg-black/70 hover:shadow-[0_15px_35px_rgba(16,185,129,0.15)] group cursor-pointer">
              <div>
                ...
                <h3 className="text-lg font-medium text-white mt-1 mb-2 group-hover:text-emerald-300 transition-colors">3. WhatsApp Automation</h3>
                <p className="text-xs text-white/65 font-light leading-relaxed">
          ...
          <Link href="/in/custom-crm" className="block min-w-[280px] sm:min-w-[320px] md:min-w-0 snap-center">
            <div className="h-full bg-black/50 border border-white/15 rounded-3xl p-7 flex flex-col justify-between backdrop-blur-xl transition-all duration-300 hover:-translate-y-2.5 hover:border-amber-400/50 hover:bg-black/70 hover:shadow-[0_15px_35px_rgba(245,158,11,0.15)] group cursor-pointer">
              <div>
                <div className="w-11 h-11 rounded-2xl bg-amber-500/10 border border-amber-500/25 flex items-center justify-center mb-6 text-amber-400 group-hover:scale-110 group-hover:bg-amber-500/20 transition-all">
                  <ShieldCheck className="w-5 h-5" />
                </div>
                <span className="text-[10px] font-mono uppercase tracking-widest text-amber-400/80">Phase 04</span>
                <h3 className="text-lg font-medium text-white mt-1 mb-2 group-hover:text-amber-300 transition-colors">4. Custom Lead Portal</h3>
                <p className="text-xs text-white/65 font-light leading-relaxed">
              ...
              <div className="mt-8 pt-4 border-t border-white/10 flex items-center justify-between text-xs text-amber-400 font-medium group-hover:translate-x-0.5 transition-all">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 pointer-events-auto w-full relative z-10">
        <ScrollReveal>
          <div className="bg-black/50 border border-white/15 rounded-3xl p-8 md:p-12 backdrop-blur-2xl">
            <div className="max-w-xl mb-10">
              <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#007AFF]">Industry Specialization</span>
              <h2 className="text-2xl md:text-3xl font-light text-white mt-2 mb-2">Sectors Where We Deploy Systems</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
              <Link href="/in/b2b-manufacturing" className="block">
                <div className="h-full p-6 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-blue-500/40 hover:bg-blue-500/[0.05] transition-all duration-300 flex flex-col items-center group cursor-pointer hover:-translate-y-1">
                  ...
                  <h4 className="font-medium text-white/90 text-xs group-hover:text-white transition-colors">B2B Manufacturing</h4>
                </div>
              </Link>

              <Link href="/in/healthcare" className="block">
                <div className="h-full p-6 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-emerald-500/40 hover:bg-emerald-500/[0.05] transition-all duration-300 flex flex-col items-center group cursor-pointer hover:-translate-y-1">
                  ...
                  <h4 className="font-medium text-white/90 text-xs group-hover:text-white transition-colors">Clinics & Healthcare</h4>
                </div>
              </Link>

              <Link href="/in/real-estate" className="block">
                <div className="h-full p-6 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-purple-500/[0.05] transition-all duration-300 flex flex-col items-center group cursor-pointer hover:-translate-y-1">
                  ...
                  <h4 className="font-medium text-white/90 text-xs group-hover:text-white transition-colors">Real Estate Systems</h4>
                </div>
              </Link>

              <Link href="/in/education" className="block">
                <div className="h-full p-6 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-amber-500/40 hover:bg-amber-500/[0.05] transition-all duration-300 flex flex-col items-center group cursor-pointer hover:-translate-y-1">
                  ...
                  <h4 className="font-medium text-white/90 text-xs group-hover:text-white transition-colors">Coaching & Academies</h4>
                </div>
              </Link>

              <Link href="/in/d2c-brands" className="block col-span-2 md:col-span-1">
                <div className="h-full p-6 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-rose-500/40 hover:bg-rose-500/[0.05] transition-all duration-300 flex flex-col items-center group cursor-pointer hover:-translate-y-1">
                  ...
                  <h4 className="font-medium text-white/90 text-xs group-hover:text-white transition-colors">D2C & Retail Brands</h4>
                </div>
              </Link>
            </div>
          </div>
      ...
      {/* 6. FAQ */}
      <section className="max-w-3xl mx-auto px-6 py-16 pointer-events-auto w-full relative z-10">
        <ScrollReveal>
          <div className="text-center mb-12">
            <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#007AFF]">Clear Answers</span>
            <h2 className="text-2xl md:text-3xl font-light text-white mt-2">Frequently Asked Questions</h2>
            <p className="text-white/60 text-xs font-light mt-1">Koi chupa hua kharcha nahi, zero technical confusion.</p>
          </div>

          <div className="space-y-4">
            <div className="p-6 rounded-2xl bg-black/50 border border-white/15 backdrop-blur-md">
      ...
      {/* 7. AUDIT FORM */}
      <section id="audit-form" className="max-w-2xl mx-auto px-6 py-16 w-full relative z-10 pointer-events-auto scroll-mt-24">
        <LeadForm variant="in" />
      </section>
      ...
      <div className="fixed bottom-6 right-6 z-50 pointer-events-auto">
        <a
          ...
          className="flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-black/80 border border-white/20 text-white/90 text-xs font-medium backdrop-blur-2xl shadow-2xl hover:border-emerald-500/40 hover:scale-105 active:scale-95 transition-all group"
        >
